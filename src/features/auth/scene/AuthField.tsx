        ...
        <input
          ...
          className={cn(
            ...
            error
              ...
              : valid
                ? 'border-brand-400/40 focus:[box-shadow:0_0_0_3px_var(--focus-ring)]'
                : 'focus:border-brand-400 border-[color-mix(in_srgb,var(--color-ink)_12%,transparent)] focus:[box-shadow:0_0_0_3px_var(--focus-ring)]',
          )}
          {...registration}
        />
